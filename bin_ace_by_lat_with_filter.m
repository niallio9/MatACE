function [ tanstruct_latbin ] = bin_ace_by_lat_with_filter( tanstruct_in, lat_bounds )
%%  A MAD filter is applied to the data after being binned to a latitude.
%
%*INPUT*
...
for i = 1:llat
    ...
    %%This next part is for applying a filter to the data
    gas_lati = apply_ace_filter_mad3(gas_lati);
    %%
    warning on
