...
%         vmrzon_clo_error = clim.vmr_zonal_error;
    end
...
%         vmrzon_hocl_error = clim.vmr_zonal_error;
    end
...
%         vmrzon_hcl_error = clim.vmr_zonal_error;
    end
...
%         vmrzon_clono2_error = clim.vmr_zonal_error;
    end
    ...
    vmrzon_clono2_error_nan2zero(isnan(vmrzon_clono2_error)) = 0;
...
%         figpos = [97,49,852,630];
        ...
        %     return
            ...
            if n == 1
                ...
                errorbar(hocl_frac, pace, hocl_frac_error, 'horizontal', 'b-', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(hcl_frac, pace, hcl_frac_error, 'horizontal', 'm-', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(clono2_frac, pace, clono2_frac_error, 'horizontal', 'r-', 'Linewidth', lw, 'MarkerSize', ms )
            elseif n == 2
...
%             vmrzon_cly_error = log(vmrzon_cly_error);
            ...
            if n == 1
                disp('plotting instrument data')
                yyaxis left
                errorbar(vmrzon_clo, pace, vmrzon_clo_error_neg, vmrzon_clo_error_pos, 'horizontal', 'go-', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_hocl, pace, vmrzon_hocl_error_neg, vmrzon_hocl_error_pos, 'horizontal', 'bo-', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_hcl, pace, vmrzon_hcl_error_neg, vmrzon_hcl_error_pos, 'horizontal', 'mo-', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_clono2, pace, vmrzon_clono2_error_neg, vmrzon_clono2_error_pos, 'horizontal', 'ro-', 'Linewidth', lw, 'MarkerSize', ms )
            ...
            elseif n == 2
                ...
                errorbar(vmrzon_hocl, pace, vmrzon_clo_error_neg, vmrzon_clo_error_pos, 'horizontal', 'b^--', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_hcl, pace, vmrzon_clo_error_neg, vmrzon_clo_error_pos, 'horizontal', 'm^--', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_clono2, pace, vmrzon_clo_error_neg, vmrzon_clo_error_pos, 'horizontal', 'r^--', 'Linewidth', lw, 'MarkerSize', ms )
                errorbar(vmrzon_cly, pace, vmrzon_clo_error_neg, vmrzon_clo_error_pos, 'horizontal', 'k^--', 'Linewidth', lw, 'MarkerSize', ms )
                yyaxis right
...
% %             set(gca, 'Ydir','reverse', 'YScale', 'log', 'Xtick', cgrid, 'XTicklabel', c, 'YMinorTick','on','YMinorGrid','OFF', 'XGrid', 'ON', 'FontSize',fs);
            ...
            %% the errors have to be fixed for teh logarithmic plot
            %logarithmic x scale
            %positive error bar
            vmrzon_clo_error_pos = vmrzon_clo_error;
            vmrzon_hocl_error_pos = vmrzon_hocl_error;
